...
Catalog.prototype.addBlock = function(catalogID, updateBlock, callback, error) {
...
Catalog.prototype.list = function(start, results, callback, error) {
    this.en.apiRequest('catalog/list', {start:start, results:results}, callback, error);
};
